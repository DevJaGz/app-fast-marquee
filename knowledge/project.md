...
6. Serve old and new Angular consumers via two version lines — see the [branch-model and version-line plan](decisions/branch-model-version-lines.md) (first publish executed 2026-07-16).
