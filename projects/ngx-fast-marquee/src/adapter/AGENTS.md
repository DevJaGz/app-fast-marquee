...
- **Tests**: co-located [`*.spec.ts`](ngx-fast-marquee.component.spec.ts) files; run with [`pnpm test:lib`](../../../../package.json). Follow convention **#14** in [`knowledge/conventions.md`](../../../../knowledge/conventions.md) — no test seams in production code.
