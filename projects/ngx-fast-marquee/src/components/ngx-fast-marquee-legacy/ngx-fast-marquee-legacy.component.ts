...
@Component({
  selector: 'ngx-fast-marquee-legacy',
  templateUrl: './ngx-fast-marquee-legacy.component.html',
  styleUrls: ['./ngx-fast-marquee-legacy.component.scss'],
  providers: [MarqueeService, MarqueeDuplicationService],
})
export class NgxFastMarqueeLegacyComponent
